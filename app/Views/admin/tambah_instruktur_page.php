                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Instruktur</h6>
                                    <a href="/admin/instruktur" class="badge badge-info badgepill mt-3">Back</a>
                                </div>
                                <div class="card-body">
                                    <form class="user" action="/admin/instruktur/tambah" method="post">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="nama_instruktur" id="nama_instruktur" placeholder="Masukkan Nama Instruktur" required>
                                            </div>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Masukkan Alamat Instruktur" required>
                                            </div>

                                            <div class="mb-3">
                                                <input type="email" class="form-control" name="email" id="email" placeholder="Masukkan Email Instruktur" required>
                                            </div>

                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="nohp" id="nohp" placeholder="Masukkan Nomor Handphone Instruktur" required>
                                            </div>

                                        </div>
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-primary btn-user btn-block" value="Tambah Data Instruktur">
                                        </div>
                                        <hr>
                                    </form>
                                </div>
