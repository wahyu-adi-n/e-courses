                        ...
                        <div class="col-xl-12 col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Pelatihan</h6>
                                    <a href="/admin/pelatihan" class="badge badge-info badgepill mt-3">Back</a>
                                </div>
                                <div class="card-body">
                                    <form class="user" action="/admin/pelatihan/tambah" method="post">
                                        <div class="form-group">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Masukkan Lokasi Pelatihan" required>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-primary btn-user btn-block" value="Tambah Data Pelatihan">
                                        </div>
                                        <hr>
                                    </form>
                                </div>
