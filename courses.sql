...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jul 2023 pada 15.35
...
(3, 'Akbar Galang Wijaya', 'Asinan', '08828766798', 'akbar@gmail.com');
...
CREATE TABLE `pelatihan` (
  `kode_pelatihan` int(11) NOT NULL,
  `nama_pelatihan` varchar(100) NOT NULL,
  `deskripsi` text NOT NULL,
  `tgl_mulai` date NOT NULL,
  `tgl_selesai` date NOT NULL,
  `lokasi` varchar(50) NOT NULL,
  `kode_instruktur` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `instruktur`
  MODIFY `kode_instruktur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `pelatihan`
--
ALTER TABLE `pelatihan`
  MODIFY `kode_pelatihan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
